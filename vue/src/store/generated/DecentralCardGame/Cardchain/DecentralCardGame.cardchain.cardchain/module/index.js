...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgReportCopyrightViolation: (data) => ({ typeUrl: "/DecentralCardGame.cardchain.cardchain.MsgReportCopyrightViolation", value: MsgReportCopyrightViolation.fromPartial(data) }),
