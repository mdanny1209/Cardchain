...
import { MsgReportCopyrightViolation } from "./types/cardchain/tx";
...
const types = [
  ...
  ["/DecentralCardGame.cardchain.cardchain.MsgReportCopyrightViolation", MsgReportCopyrightViolation],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgReportCopyrightViolation: (data: MsgReportCopyrightViolation): EncodeObject => ({ typeUrl: "/DecentralCardGame.cardchain.cardchain.MsgReportCopyrightViolation", value: MsgReportCopyrightViolation.fromPartial( data ) }),
